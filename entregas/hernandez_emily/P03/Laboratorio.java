...
//
// ESCRIBE TU NOMBRE AQUI: HERNANDEZ NIUEVES EMIL 
//                         SANCHEZ MENDEZ CITLALI ITZEL
// ============================================================================
//
...
public class Laboratorio {
    ...
    static void bloque7() {
        ...
        // Usamos un decimal para que la division sea decimal.
        System.out.println("7.1 = " + ((double) 5 / 2));

        // 7.2 Con % , una expresion que diga si 47 es par.
        // Usamos % para obtener el residuo de dividir 47 entre 2.
        System.out.println("7.2 = " + (47 % 2 == 0));

        // 7.3 Un casting que convierta 9.99 en entero.
        // Se pierde 0.99 porque el casting a int elimina la parte decimal.
        System.out.println("7.3 = " + ((int) 9.99));

        // 7.4 Comparar 0.1 + 0.2 contra 0.3 SIN usar ==.
        // Math.abs obtiene la diferencia absoluta y comprobamos si es menor que 0.000001.
        System.out.println("7.4 = " + (Math.abs((0.1 + 0.2) - 0.3) < 0.000001));

        // 7.5 Un && que aproveche el corto circuito para NO dividir entre cero.
        // Si divisor es 0, la primera condicion es false y Java no evalua la division.
        int divisor = 0;
        System.out.println("7.5 = " + (divisor != 0 && 10 / divisor > 1));
