...
public class Laboratorio {
    ...
    static void bloque7() {
        ...
        // Use el casting (double) para convertir el 5 a decimal antes de dividir y evitar una division entera.
        System.out.println("7.1 = " + ( (double) 5 / 2 ));

        // 7.2  Con % , una expresion que diga si 47 es par. Debe imprimir false    
        // Use el operador % (modulo) para sacar el residuo de la division y == para comparar si es igual a cero.
        ...
        // Use el casting (int) para convertir a entero. Se perdio 0.99 porque el casting simplemente corta la parte decimal sin redondear.
        ...
        // Use Math.abs() para obtener la diferencia sin signo negativo y el operador < para revisar si esa diferencia es menor al margen de error.
        ...
        // int divisor = 0;
        // Use el operador && para validar que el divisor no sea cero; si la primera condicion no se cumple, Java no evalua la segunda parte y evita que truene.
        int divisor = 0;
