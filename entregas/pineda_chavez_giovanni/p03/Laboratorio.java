...
//
// ESCRIBE TU NOMBRE AQUI: Pineda Chavez Giovanni, Bravo Olmedo Paulo Cesar
// ============================================================================
//
...
public class Laboratorio {
    ...
    static void bloque7() {
        ...
        // si escribiamos 5/2 detectaria puro entero por lo que ignoraria el punto pero al poner 5/2.0 detecta un Double y me da el resultado en decimales
        
        // 7.2  Con % , una expresion que diga si 47 es par. Debe imprimir false
        System.out.println("7.2 = " + (47 % 2 == 0));
        //El operador módulo (%) calcula el residuo de una división. La regla dicta que un número es par solo si su residuo al dividirlo entre 2 es exactamente 0.
        // Como 47 dividido entre 2 deja un residuo de 1, la afirmación evalúa automáticamente a false

        // 7.3  Un casting que convierta 9.99 en entero.
        //      Se perdió 0.99 porque el casting a un tipo de dato entero (int) 
        //      simplemente trunca (recorta) la parte decimal, no redondea el número.
        System.out.println("7.3 = " + ((int) 9.99));
        //Se utiliza un casting explícito porque Java requiere que le confirmes manualmente cuando quieres convertir un tipo de dato (int) en este caso. 
        // La conversión siempre funciona truncando, es decir, cortando todo lo que esté después del punto sin importar si está cerca de redondearse al siguiente número.

        // 7.4  Comparar 0.1 + 0.2 contra 0.3 SIN usar == , y que imprima true.
        System.out.println("7.4 = " + (Math.abs((0.1 + 0.2) - 0.3) < 0.000001));
        //Las computadoras no pueden representar algunos decimales de forma exacta a nivel binario (en Java, 0.1 + 0.2 da 0.30000000000000004). En lugar de usar == (que fallaría),
        // se saca la diferencia matemática entre ambos valores y se usa Math.abs para asegurar que el margen de error sea positivo y menor a una tolerancia minúscula (0.000001).
        
        // 7.5  Un && que aproveche el corto circuito para NO dividir entre cero.
        int divisor = 0;
        System.out.println("7.5 = " + (divisor != 0 && (10 / divisor > 0)));
        //El operador lógico AND (&&) tiene una propiedad llamada corto circuito. Evalúa de izquierda a derecha; si la primera condición (divisor != 0) resulta ser falsa,
        // Java sabe que toda la expresión será falsa y se detiene inmediatamente. Esto evita que lea la segunda parte (10 / divisor) y el programa truene por intentar dividir entre cero.
    }
