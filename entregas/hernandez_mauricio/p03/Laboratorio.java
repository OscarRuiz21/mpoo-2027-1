...
public class Laboratorio {
    ...
    static void bloque7() {
        ...
        //Si dividmos un numero entero entre un double,todo se hace double
         System.out.println("7.1 = " + (5/2.0));

        // 7.2  Con % , una expresion que diga si 47 es par. Debe imprimir false
         //Usamos el operador % ya que sabemos que si el residuo de un numero es 0,el numero es primo
        ...
        //En este cast explicito se corta el numero a 9, se pierden dos decimales .99
        ...
        //En este caso al evaluar la primera expresion 0=0 por lo que ya no entra a &&,ya que ambas se tienen que cumplir
         int divisor = 0;
