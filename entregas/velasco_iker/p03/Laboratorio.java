...
//
// ESCRIBE TU NOMBRE AQUI: Medina Reyes Miguel Angel, Velasco Gómez Iker Alejandro
// ============================================================================
//
...
// 7.1 Que imprima exactamente 2.5, partiendo de los numeros 5 y 2.
        ...
        // Se perdió 0.99 debido a que el casting (int) trunca la parte decimal eliminándola sin redondear.
