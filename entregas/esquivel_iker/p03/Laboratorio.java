...
public class Laboratorio {
    ...
    static void bloque7() {
        ...
        System.out.println("7.1 = " + ((double) 5 / 2)); // Operador de casting (double) y division /

        // 7.2  Con % , una expresion que diga si 47 es par. Debe imprimir false
        System.out.println("7.2 = " + (47 % 2 == 0)); // Operador modulo % y de igualdad ==

        // 7.3  Un casting que convierta 9.99 en entero.
        //      En el comentario escribe cuanto se perdio y por que:
        //      Se perdio 0.99 porque el casting (int) no redondea, sino que trunca/corta la parte decimal.
        System.out.println("7.3 = " + ((int) 9.99)); // Operador de casting (int)
        ...
        System.out.println("7.4 = " + (Math.abs((0.1 + 0.2) - 0.3) < 0.000001)); // Operadores -, + y relacional <
        ...
        int divisor = 0;
        System.out.println("7.5 = " + (divisor != 0 && 10 / divisor > 1)); // Operadores !=, &&, / y >
