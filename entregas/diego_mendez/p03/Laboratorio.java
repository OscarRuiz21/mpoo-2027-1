...
public class Laboratorio {
    ...
    static void bloque7() {
       ...
       // 7.1  Que imprima exactamente 2.5, partiendo de los numeros 5 y 2.
        // Usé el operador de división / aplicando casting (double) al dividendo 5 para forzar la división decimal.
        System.out.println("7.1 = " + ( (double) 5 / 2 ));

        // 7.2  Con % , una expresion que diga si 47 es par. Debe imprimir false
        // Usé el operador módulo % para obtener el residuo de 47 entre 2 y el operador == para comparar si da 0.
        System.out.println("7.2 = " + ( 47 % 2 == 0 ));

        // 7.3  Un casting que convierta 9.99 en entero.
        // Usé el casting (int) para truncar 9.99. Se perdieron 0.99 decimales porque el casting a int no redondea, solo recorta la parte decimal.
        System.out.println("7.3 = " + ( (int) 9.99 ));

        // 7.4  Comparar 0.1 + 0.2 contra 0.3 SIN usar == , y que imprima true.
        // Usé Math.abs para sacar la diferencia absoluta y el operador < para verificar si la imprecisión en coma flotante es menor a 0.000001.
        System.out.println("7.4 = " + ( Math.abs((0.1 + 0.2) - 0.3) < 0.000001 ));

        // 7.5  Un && que aproveche el corto circuito para NO dividir entre cero.
        // Usé el operador de desigualdad != con && para asegurarme de que si el divisor es 0, el cortocircuito no evalúe la división y no truene.
        int divisorEvaluado = 0;
        System.out.println("7.5 = " + ( divisorEvaluado != 0 && 10 / divisorEvaluado > 1 ));
