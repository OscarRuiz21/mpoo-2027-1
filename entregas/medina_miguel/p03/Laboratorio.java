...
//
// ESCRIBE TU NOMBRE AQUI: Velasco Gómez Iker Alejandro, Medina Reyes Miguel Angel
// ============================================================================
//
...
public class Laboratorio {
    ...
    static void bloque7() {
        ...
        System.out.println("7.1 = " + ((double) 5 / 2)); // Operador de division y casting explicito

        // 7.2  Con % , una expresion que diga si 47 es par. Debe imprimir false
        System.out.println("7.2 = " + (47 % 2 == 0)); // Operador modulo y operador relacional de igualdad

        // 7.3  Un casting que convierta 9.99 en entero.
        //      En el comentario escribe cuanto se perdio y por que
        System.out.println("7.3 = " + ((int) 9.99)); // Casting explicito a int. Se perdio 0.99 porque el casting trunca la parte decimal.
        ...
        System.out.println("7.4 = " + (Math.abs((0.1 + 0.2) - 0.3) < 0.000001)); // Metodo valor absoluto y operador relacional menor que
        ...
        int divisor = 0;
        System.out.println("7.5 = " + (divisor != 0 && (10 / divisor > 1))); // Operadores logicos y relacionales con corto circuito
